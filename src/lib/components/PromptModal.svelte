		...
		<div class="panel animate-fade-in w-full max-w-md p-5">
			...
			<div class="mb-6">
				<input
					...
					type="text"
					{placeholder}
					class="w-full rounded border border-(--color-gold)/20 bg-(--color-void)/60 px-3 py-2 text-(--color-parchment) placeholder-(--color-ash)/60 transition-colors focus:border-(--color-gold)/50 focus:outline-none"
				/>
			</div>
